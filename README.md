...
1st Year in Bachelor of Computer Science (Network & Computer Security) with Honours

# Position
## Sekolah Rendah Kebangsaan Bukit Rahman Putra
- Library prefect (Member)

## Sekolah Menengah Kebangsaan Bukit Rahman Putra
- Peer Prefect (Member)
- Chess Team (Leader)
- SMKBRP Music Band (Keyboardist)

## Universiti Teknologi Mara
- Chess Club (Member)

## Universiti Teknologi Malaysia
- UTM Japanese Club (Publicity & Media Team)
- Senimas KTR (Member)
- Rasrec KTR (Member)

## External
- Professional Valorant NEXGA (Player)

# Skills
## Programming Language, Applications & Softwares
- C++ (Embarcardero DevC++, VScode)
- Git / Github
- Capcut
- Canva
- DEEDS Softwares
...
## Soft Skills
- Leadership - Capable of guiding teams and taking responsibility when needed
- Adaptability - Able to adapt into new environment quickly
- Critical Thinking - Evaluates situations logically before making decisions
- Problem-Solving - Able to break down complex problems and find practical solutions
- Teamwork - Works effectively with others in group projects and discussions
